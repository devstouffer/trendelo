  ...
  return (
    <div className="relative min-h-screen flex flex-col" style={{ backgroundColor: "var(--color-mint)" }}>
      ...
      <main className="relative z-10 flex flex-col flex-1 items-center justify-center px-6 py-12">
        ...
        <p className="text-lg mb-12 text-center" style={{ color: "var(--color-on-surface-muted)" }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl">
          {tracks.map((track) => (
            ...
            >
              ...
              <p className="text-sm mb-8 leading-relaxed" style={{ color: "var(--color-on-surface-muted)" }}>
                {track.description}
              </p>
        ...
        <div className="mt-14 flex flex-col items-center gap-2">
          ...
          >
            <div className="h-full rounded-full" style={{ width: "33%", backgroundColor: "var(--color-primary)" }} />
          </div>
          <span
